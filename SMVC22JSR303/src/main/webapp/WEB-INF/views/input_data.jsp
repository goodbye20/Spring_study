...
<body>
	<h1>input_data</h1>
		<form:form action="input_pro" modelAttribute="dataVO1" method="post">
			...
			data4 : <form:input path="data4" type="int"/><br>
			...
			data7 : <form:input path="data7" type="int"/><br>
			...
			data12 : <form:input path="data12" type="int"/><br>
					<form:errors path="data12"/><br>
					
			data13 : <form:input path="data13" type="int"/><br>
					<form:errors path="data13"/><br>
					
			data14 : <form:input path="data14" type="int"/><br>
					<form:errors path="data14"/><br>
					
			data15 : <form:input path="data15" type="int"/><br>
